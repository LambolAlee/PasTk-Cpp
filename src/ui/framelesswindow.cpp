...
void CFramelessWindow::makeFrameless(QWidget *w, TitleBar *titleBar, QLabel *title)
{
    // wrap the QMainWindow with frameless window
    auto content = new QWidget(this);
    titleBar->setParent(content);
    w->setParent(content);
...
void CFramelessWindow::setTitleBar(TitleBar* titlebar)
{
    m_titlebar = titlebar;
    if (!titlebar) return;
