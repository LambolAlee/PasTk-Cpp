...
public:
    ...
    void makeFrameless(QWidget *w, TitleBar *titleBar, QLabel *title);
protected:
    ...
    bool nativeEvent(const QByteArray &eventType, void *message, qintptr *result) override; // long * -> qintptr
